...
import 'package:distributor/ui/views/register/register_viewmodel.dart';
...
class RegisterView extends StatefulWidget {
  ...
  const RegisterView({Key key, this.userId, this.password}) : super(key: key);
  @override
...
class _RegisterViewState extends State<RegisterView> {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<RegisterViewModel>.reactive(
      ...
      // viewModelBuilder: () => RegisterViewModel(widget.userId, widget.password),
